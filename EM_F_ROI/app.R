                        ...
                        div(id = "full_pay",
                            inputPanel(
                                verticalLayout(
                                    ...
                                    numericInput("zip_code", "ZIP code of current residence:", value = NULL),
                                    ...
                                    div(id = "full_out",
                                        ...
                                        selectInput("em_power", "How much ability do you have to effect change in emergency medicine nationally?", choices = c('None', 'Minimal', 'Some', 'A Lot')),
                                        selectInput("you_fired", "Since January, 2020, have you been fired from a job?", choices = c('No', 'Yes')),
                                        selectInput("other_fired", "Since January, 2020, have any of your coworkers been fired from your current job?", choices = c('No', 'Yes')),
